        ...
        on: {
            ready: function() {
                $('.p50c4Carousel01 .b-slider__slide').each(function() {
                    ...
                    // Debugging: cek apakah data-img ada
                    console.log("Gambar ditemukan:", imgSrc);

                    // Jika data-img kosong, pakai gambar default atau skip
                    if (!imgSrc || imgSrc.trim() === '') {
                        console.warn("Gambar tidak ditemukan untuk elemen ini:", this);
                        imgSrc = '/assets/images/fallback.jpg'; // Ganti dengan gambar default yang ada
                    }
            ...
            change: function(index) {
                console.log("Slide berubah ke index:", index);
            }
        }
    });
