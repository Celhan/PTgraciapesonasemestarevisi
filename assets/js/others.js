$(function() {
  ...
  function generateMapTable() {
    var $table = $('<table>').attr('border', '0');
    var $thead = $('<thead>').appendTo($table);
    $thead.append('<tr><th>Product</th><th>Description</th><th>Function</th><th>Technology</th><th></th><th>Indicator</th></tr>');

    var $tbody = $('<tbody>').appendTo($table);
    var shownMonths = {}; // Reset shownMonths for each region
    
    var monthsToShow = ["ELJE EL POWER SERIES 10-800kVA", "May", "June", "July", "Aug", "Sep", "Oct"];
